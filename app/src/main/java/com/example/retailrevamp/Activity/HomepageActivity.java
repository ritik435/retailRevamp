package com.example.retailrevamp.Activity;
...
import com.example.retailrevamp.Adapter.StatsticsInfoAdapter;
import com.example.retailrevamp.Adapter.TransactionAdapter;
import com.example.retailrevamp.Constant.Tags;
import com.example.retailrevamp.Fragment.AddTransactionFragment;
import com.example.retailrevamp.Fragment.AllTransactionsFragment;
import com.example.retailrevamp.Fragment.CreateKhataFragment;
import com.example.retailrevamp.Fragment.KhataFragment;
import com.example.retailrevamp.Fragment.LoginFragment;
...
import com.example.retailrevamp.Utils.GoogleSheetsManager;
import com.example.retailrevamp.Utils.LocaleHelper;
...
//        addElementsInRecents();
    ...
    public void manipulateAddTransactionFragment(String keyAddTransaction, boolean toOpen) {
        ...
        if (toOpen) {
            ...
            addTransactionFragment = AddTransactionFragment.newInstance(keyAddTransaction, "");
    ...
    public void manipulateCreateKhataFragment(boolean toOpen) {
        if (toOpen) {
            ...
            getSupportFragmentManager().beginTransaction().setCustomAnimations(R.anim.slide_in_right, R.anim.slide_out_right).add(flCreateKhataFragment.getId(), createKhataFragment).addToBackStack(null).commit();
    ...
    public void manipulateKhataFragment(boolean toOpen) {
        if (toOpen) {
            flKhataFragment.setVisibility(View.VISIBLE);
            khataFragment = KhataFragment.newInstance("", "");
